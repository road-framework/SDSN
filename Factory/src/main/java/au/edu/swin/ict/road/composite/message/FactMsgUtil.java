...
/**
 * This is a uutility class which provides methods to get details from the fact messages
 *
...
public class FactMsgUtil {
    ...
    /**
     * This method extract the fact Id from the given MessageWrapper and returns it
     *
     * @param mw
     * @return
     */
