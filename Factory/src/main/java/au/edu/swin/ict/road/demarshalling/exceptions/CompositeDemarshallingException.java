...
/**
 * CompositeDemarshallingException can be thrown when an error occurs transforming
 * the xml version of a composite into the concrete java version, for example if the xml
 * file can not be read or is not well formed.
 *
...
public class CompositeDemarshallingException extends Exception {
    ...
    /**
     * The default CompositeDemarshallingException constructor. Throws
