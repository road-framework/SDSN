...
//            Composite composite = dm.demarshalSMC("src\\main\\resources\\management\\ms10\\smc_source.xml");
...
//            compo.start();
//            Thread.sleep(5000);
//            Thread pe2 = new Thread(new PolicyExecutor(composite, "es10_org", "es10_org_add.drl", true));
//            pe2.start();
//            Thread pe3 = new Thread(new PolicyExecutor(composite, "es10_opr", "es10_opr_add.drl", false));
//            pe3.start();
//            Thread.sleep(20000);
...
//            tenant14.start();
//            Thread.sleep(40000);
//            Thread pe4 = new Thread(new PolicyExecutor(composite, "es10_org_remove", "es10_org_remove.drl", true));
//            pe4.start();
//            Thread pe5 = new Thread(new PolicyExecutor(composite, "es10_opr_remove", "es10_opr_remove.drl", false));
//            pe5.start();
//            Thread.sleep(20000);
