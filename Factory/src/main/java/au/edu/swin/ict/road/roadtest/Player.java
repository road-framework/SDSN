...
public class Player {
     ...
     *
     * @param role The Role which <code>this</code> Player is going to play
     */
    ...
    public Player(IRole role) {
        ...
        for (Operation o : listOperation) {
            this.providedNew.put(o.getName(), ObjectParameterHelper
                    .getParameterMap(o.getParameters()));
        }
        ...
        for (Operation o : listOperation) {
            this.requiredNew.put(o.getName(), ObjectParameterHelper
                    .getParameterMap(o.getParameters()));
        }
    ...
    public void sendMessage(String msgSignature, String msgContent,
        ...
        role.putMessage(mw);
        /*boolean found = false;
          for(Operation o : role.getProvidedOperationsList()){
              if(o.getName().equalsIgnoreCase(message.getOperationName()) && !o.getReturnType().equalsIgnoreCase("void")){
                  found = true;
              }
          }
          if(!found)
              ...
              role.putSyncMessage(mw);*/
    }

    /**
     * Sends a message with the message object usually from the interval sender
     *
     * @param message The Message object which is going to be sent
     */
     ...
     *
     * @param msgSignature The signature of the message
     * @param msgContent   The content of the message
     * @param interval     the interval in which this message is going to be fired in
     *                     <code>long</code>
     ...
     *
     * @param inMsgSignature  The message signature to which it needs to auto respond
     * @param outMsgSignature The message signature with which this player has to auto
     *                        respond
     * @param msgContent      The content of the auto response message
     * @param delay           The delay for the auto response >=0
     ...
     *
     * @param uid the uid for which the interval message should be started as
     *            <code>UUID</code>
     * @throws NullPointerException Is going to be thrown if the uid is not available
     */
     ...
     *
     * @param uid the uid for which the auto response needs to be started
     * @throws NullPointerException Is going to be thrown if the uid is not available
     */
     ...
     *
     * @param uid the uid for which the interval message should be stopped as
     *            <code>UUID</code>
     * @throws NullPointerException Is going to be thrown if the uid is not available
     */
     ...
     *
     * @param uid the uid for which the auto response message should be stopped
     *            as <code>UUID</code>
     * @throws NullPointerException Is going to be thrown if the uid is not available
     */
     ...
     *
     * @param cs The connection settings as a <code>ConnectionSettings</code>
     *           object
     ...
     * Sets the connection for this player with the connection setting cs
     *
     * @param serverAddress The ip address of the server to which it needs to connect as
     *                      <code>String</code>
     * @return String array with available composites on the given IP if alr
     * @throws RemoteException
     */
     ...
     *
     * @param composite String to which composite on the server it should connect
     ...
     *
     * @throws RoleNotFoundException Throws this exception if the role id is not available on the
     *                               connected composite
     */
     ...
     *
     * @param id The role id of the connected composite
     * @throws RoleNotFoundException Throws this exception if the role id is not available on the
     *                               connected composite
     */
