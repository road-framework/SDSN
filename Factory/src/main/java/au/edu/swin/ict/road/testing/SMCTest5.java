...
public class SMCTest5 {
    ...
    public static void main(String args[]) {
        try {
            ...
            Composite composite = dm.demarshalSMC("src\\main\\resources\\management\\ms8\\smc_source.xml");
            ...
            compo.start();
            Thread.sleep(5000);
            Thread pe2 = new Thread(new PolicyExecutor(composite, "es8_org", "es8_org_add.drl", true));
            pe2.start();
            Thread pe3 = new Thread(new PolicyExecutor(composite, "es8_opr", "es8_opr_add.drl", false));
            pe3.start();
            Thread.sleep(20000);
            ...
            tenant14.start();
            Thread.sleep(40000);
            Thread pe4 = new Thread(new PolicyExecutor(composite, "es8_org_remove", "es8_org_remove.drl", true));
            pe4.start();
            Thread pe5 = new Thread(new PolicyExecutor(composite, "es8_opr_remove", "es8_opr_remove.drl", false));
            pe5.start();
            Thread.sleep(20000);
