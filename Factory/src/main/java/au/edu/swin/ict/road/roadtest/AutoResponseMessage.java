...
public class AutoResponseMessage extends Message {
     ...
     *
     * @param inMsgSignature  The in message signature to which this has to response as
     *                        <code>String</code>
     * @param outMsgSignature The response signature which is going to be called as
     *                        <code>String</code>
     * @param msgContent      The content of the response message as <code>String</code>
     * @param delay           the delay as <code>long</code>
     */
