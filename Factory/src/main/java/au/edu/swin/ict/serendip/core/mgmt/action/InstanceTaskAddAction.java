...
public class InstanceTaskAddAction implements InstanceAdaptAction, Constants {
    ...
    public InstanceTaskAddAction(String btid, String taskId, String preep, String postep, String obligrole, String pp) {
        this.btId = btid;
    ...
    public boolean adapt(ProcessInstance pi) throws AdaptationException {
        ...
        //No such BT
        if (null == parentBt) {
            throw new AdaptationException("Cannot find behaviour term " + this.btId);
        }

        //TODO: Do we need to check for pre-conditions before adding the Task.

        //TODO: Check for existance of role
        if (null == pi.getEngine().getComposition().getComposite().getRoleByID(this.obligrole)) {
