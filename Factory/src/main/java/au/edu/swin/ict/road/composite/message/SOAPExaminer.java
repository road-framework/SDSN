...
public class SOAPExaminer extends MessageTypeExaminer {
     ...
     * routing rules, called query name. It retrieves the content of the tag
     * by using external library.
     * <br />
    ...
    /**
     * Procedure to traverse the SOAP message content to search for a
     * specific query or tag name. It provides the in-depth search of a
     * specific tag name inside the SOAP message, which the Axiom library
     * does not provide. It is called recursively and ultimately putting
     * the query name with the content in a map. The recursive function
     * uses a modified depth-first search algorithm.
     *
     * @param element   the element to be traversed.
     * @param queryName the query name to be matched.
     */
