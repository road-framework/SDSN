...
public interface IServerRMI extends Remote {
     ...
     * Sends a message
     *
     * @param role     The role from where a message is going to be sent
     * @param msgSig   The signature of the message
     * @param msgCont  THe message content
     * @param response If this message should be considered as a response
