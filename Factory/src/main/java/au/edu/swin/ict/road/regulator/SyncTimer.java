...
// * <code>FactSynchroniser</code> to load facts. The timer is only
// * used when the regulator is set to <em>active</em> mode.
// * <p/>
...
//	public void forward() {
//
//		MessageWrapper factMessage = new MessageWrapper("Requesting Facts", "request"
//				+ fSync.getFactType() + "FactsFromPlayer", false);
