...
public interface Constants {
    ...
    public enum commands {
        updatePropertyOfTask,
        updatePropertyOfProcessInstance,
        addConstraintToInstance,
        addNewTaskToInstance,
        executeScript,
        updateProcessInstanceState,
        updateStateOfAllProcessInstances,
        pause,
        resume,
        //DEF LEVEL
        ...
        updateTaskRef,
        removeTaskRef,
        addConstraintToBehavior,
        updateConstraintToBehavior,
        removeConstraintToBehavior,
        addTerm,
        updateTerm,
        removeTerm,
        addPlayerBinding,
        ...
        removeProcessDef,
        updateProcessDef,
        removeBehaviorRefFromProcessDef,
    ...
    //Following are the constants that are being used in the script as keys in key=val pairs
