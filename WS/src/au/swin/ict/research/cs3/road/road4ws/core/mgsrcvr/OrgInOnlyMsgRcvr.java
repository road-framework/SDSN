 ...
 */
public class OrgInOnlyMsgRcvr extends org.apache.axis2.rpc.receivers.RPCInOnlyMessageReceiver {
    ...
    /**
     * Invoke the organizer object.
     * Tip: We pass a reference of organizer to the super via msg context
     */
    ...
    /**
     * We do not create a new one. The organizer has to remain the same. Cannot have two organizer objects for the same composition.
     */
