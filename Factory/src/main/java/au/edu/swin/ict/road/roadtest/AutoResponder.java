...
public class AutoResponder {
     ...
     *
     * @param player          The player whom this auto responder belongs as
     *                        <code>Player</code>
     * @param autoRespMessage The message which contains the settings for the auto response
     */
     ...
     *
     * @param stopped the stopped to set true so the auto response can not start
     *                false it can
     */
