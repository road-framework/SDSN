...
public class EventPatternParser extends antlr.LLkParser implements EventPatternParserTokenTypes {
    ...
    public final void xorpattern() throws RecognitionException, TokenStreamException {
    ...
    public final void orpattern() throws RecognitionException, TokenStreamException {
    ...
    public final void andpattern() throws RecognitionException, TokenStreamException {
