 ...
 * The class is a place holder for such utility methods that parses a SOAP message
 *
 * @author Malinda Kapuruge
 */
public class MessageParser {
    private static final Logger log = Logger.getLogger(ROADMsgHandler.class.getName());

    /**
     * Parse a message to identify the composite name and the originated Role name.
     * <code>Array[1] = Composite name</code>
     * <code>Array[2] = Role name</code>
     *
     * @param msgContext the message context of the Axis2.
     ...
     *
     * @param msgContext the message context of the Axis2
     * @param compName   the composite name
     ...
     * @param roleName   Name of the role. In the sense the name of the corresponding service
