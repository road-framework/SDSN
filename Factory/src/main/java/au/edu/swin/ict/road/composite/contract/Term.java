...
public class Term {
    ...
    public Term(String id, String direction, IContractRules rules) {
        this();
        this.id = id;
        this.name = id;
        this.direction = direction;
     ...
     *
     * @param msg the message to evaluate with rules
    ...
    public ContractEvaluationResult processMessage(MessageWrapper msg) {
        ...
        try {
            ...
            mpr = (ContractEvaluationResult) rules.insertEvent(new MessageReceivedEvent(msg));
     ...
     *
     * @param operation the <code>Operation</code> for this <code>Term</code>.
     */
     ...
     *
     * @param messageType the message type of this term.
     */
