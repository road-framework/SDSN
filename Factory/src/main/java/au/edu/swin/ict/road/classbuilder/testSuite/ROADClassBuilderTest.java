...
public class ROADClassBuilderTest {
    private static Logger log = Logger.getLogger(ROADClassBuilderTest.class.getName());
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        params2.add(new Parameter("au.edu.swin.ict.road.classbuilder.testSuite.Person", "person"));
