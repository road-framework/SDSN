...
/**
 * The default implementation of the the interface ClassBuilder. This class
 * only provides basic functionalities of loading and building a class, as
 * well as retrieving the class loader.
 *
...
public class ClassBuilder implements IClassBuilder {
    ...
    @Override
    public Class<?> build(String pkgName, String className, List<ClassOperations> operations) {

        // Parsing the qualified class name, in case no package is specified, it just uses the class name
        ...
        // Retrieving the default class pool and load the pool into the class loader
        CtClass cc = null;
...
//				paramArray[0] = paramType;
                ...
                try {
                    ...
                    String methodStr = op.getVisibility() + " " + op.getOutParam() + " ";
                    ...
                    aMethod.setAttribute("paramNames", op.getInParams().getBytes());
