...
public class OrganiserComponentTerm extends JPanel {
    ...
    private void jButtonSave_actionPerformed(ActionEvent e) {
        ...
        if (c != null) {
            ...
            String messageType = this.jComboBoxType.getSelectedItem().toString();
            String deonticType = this.jComboBoxDeonticType.getSelectedItem().toString();
            String description = this.jTextFieldDescription.getText().trim();
            String direction = this.jComboBoxDirection.getSelectedItem().toString();
            String contractId = c.getId();
            myComposite.addNewTerm(id, name, messageType, deonticType, description, direction, contractId);
