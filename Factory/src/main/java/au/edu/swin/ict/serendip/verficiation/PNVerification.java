...
public class PNVerification implements SerendipVerification {
    ...
    throws SerendipVerificationException {
        ...
        List<ProcessDefinitionsType> processDefinitionTypeList = comp
                .getComposite().getSmcBinding().getVirtualServiceNetwork();
        for (ProcessDefinitionsType pdst : processDefinitionTypeList) {
            for (ProcessDefinitionType pdt : pdst.getProcess()) {
    ...
    throws SerendipVerificationException {
        ...
        CollaborationUnitType[] bts = CompositionUtil.getBehaviorTermsForBTIDs(
        ...
        ConstraintType[] constraints = CompositionUtil
                .getAllConstriantsForBTs(new CollaborationUnitType[]{bts[0]});
    ...
    private VerificationResult verifyEPC(String id,
        ...
        List<String> constrintsIdVec = new ArrayList<String>();
