...
public class ClassOperations {
    ...
    private String opName;        // The name of the operation of the class. e.g. addPerson
    private String inParams;    // Parameters as a String. e.g. String name, int age, boolean married
    ...
    /**
     * The constructor is used to create a description for a Java operation.
     ...
     * </code>
     * is equal in comparison to method
     * <code>
     ...
     * </code>
     *
     * @param visibility visibility of the operation e.g. public
     * @param outParam   the return value
     * @param opName     operation name
     * @param inParams   input parameters in comma separated String
     */
    public ClassOperations(String visibility, String outParam, String opName, String inParams, String methodBody) {
        super();
    ...
    public String toString() {
        return "" + this.visibility + " " + this.outParam + " " + this.opName + " (" + this.outParam + "){" + this.methodBody + "}";
    }
