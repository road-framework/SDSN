...
public class Main {
    ...
    public static void main(String[] args) throws SerendipException {
        ...
        //Add a new message
        //composite.getRoleByID("MM").putMessage(new MessageWrapper(null, "", false));
        ...
        for (int i = 0; i < 100; i++) {//We fire three initial events
            ...
            composite.getSerendipEngine().addEvent(new EventRecord("[ComplainRcvd]", null));//This will instantiate a process instance
            try {
                Thread.sleep(500);
            } catch (InterruptedException e) {
                // TODO Auto-generated catch block
