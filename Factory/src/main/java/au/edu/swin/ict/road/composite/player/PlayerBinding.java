...
public class PlayerBinding {
    ...
    private void extractData(PlayerBindingType playerBinding) {
        ...
        if (playerBinding.getRoles() != null) {
    ...
    /**
     * Creates and returns the player binding object from the composite's
     * player binding object to use in the JAXB transformation of the XML
