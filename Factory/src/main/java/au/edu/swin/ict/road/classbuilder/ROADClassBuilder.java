...
public class ROADClassBuilder extends ClassBuilder {
     ...
     * body is return null.
     *
     * @param pkgName    the name of the package of the runtime generated class.
     * @param className  the name of the runtime generated class.
     * @param operations a list of operations defined by ROADfactory.
     */
     ...
     *
     * @param fullClassName the class name of the class to load.
