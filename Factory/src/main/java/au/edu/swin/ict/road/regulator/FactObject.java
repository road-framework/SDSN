...
public class FactObject implements Cloneable {
     ...
     * </ul>
     *
     * @param obj another <code>FactObject</code>, however it is possible to put
    ...
    public boolean equalsInStructure(Object obj) {
        if (obj == null)
            ...
            if (factObj.getFactType().equalsIgnoreCase(this.getFactType())) {
                if (factObj.getIdentifier().equals(this.getIdentifier())) {
                    return this.getAttributes().keySet().equals(
                            factObj.getAttributes().keySet());
                }
            }
        }
     ...
     * </ul>
     *
     * @param obj another <code>FactObject</code> to be compared to. Generally,
    ...
    public String toXMLString() {
        ...
        strBldr.append("</attributes>");
        strBldr
                .append("<identifier><identifierKey>" + this.getIdentifier()
                        + "</identifierKey>" + "<identifierValue>"
                        + this.getUniqueId()
                        + "</identifierValue></identifier>");
        strBldr.append("<name>" + this.getFactType() + "</name>" + "<source>" + factSource + "</source>");
