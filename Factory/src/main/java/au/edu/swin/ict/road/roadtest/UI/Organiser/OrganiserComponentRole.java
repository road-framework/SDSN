...
public class OrganiserComponentRole extends JPanel {
     ...
     * @param node        <code>DefaultMutableTreeNode</code> node that is selected
     */
    public OrganiserComponentRole(ROADTest myComposite, DefaultMutableTreeNode node) {
        super();
     ...
     *
     * @param e <code>ActionEvent</code> e an action event
     */
