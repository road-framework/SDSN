...
public class Message implements Comparable<Message> {
     ...
     *
     * @param mw The <code>MessageWrapper</code> of which this message is going
     *           to be created.
     */
     ...
     * @param originRoleId
     */
    public Message(String msgContent, String operationName, String originRoleId, boolean response) {
        Calendar cal = Calendar.getInstance();
        this.timeStamp = cal.getTime();
