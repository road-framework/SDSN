...
/**
 * ConsistencyViolationException is thrown if a change to a composite
 * violates its structural integrity, e.g. a contract bound to a role that
 * does not exist or the use of a duplicate unique id.
 *
...
public class ConsistencyViolationException extends Exception {
    ...
    /**
     * The default ConsistencyViolationException constructor. Throws
