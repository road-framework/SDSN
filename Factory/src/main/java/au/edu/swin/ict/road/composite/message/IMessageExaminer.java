 ...
 * message signature conflict, and is based on multiple preferences found
 * inside the message.
 * <br />
...
public interface IMessageExaminer {
    ...
    /**
     * Function that checks the type of the message, and parse it accordingly
     * to the currently implemented solutions. This is the only method that
     * needs to be implemented whenever there is a new supported message type.
     *
     ...
     * allocator will check on whose role has the least queue size.
     * <br/>
     * This method must be implemented in the specific message checker and not
     * in the MessageTypeChecker class.
     *
     * @param roleId the destination role id for a contract.
     */
     ...
     * Note that the message would still be blocked in the term level if it
     * is not supported by the contract.
     * <br/>
     * This method is to be implemented in the specific message checker.
     *
     * @param queryName the query names to be added
     */
     ...
     * the names of the queries that are found in the message.
     * <br/>
     * This method is to be implemented in the specific message checker.
     *
     ...
     * values in the query. This is represented in a map.
     * <br/>
     * This method is to be implemented in the specific message checker.
     *
    ...
    /**
     * Function to retrieve the content type of the message.
     * <br/>
     * This method is to be implemented in the specific message checker.
     *
     ...
     * checked against the supported message content type.
     * <br/>
     * This method is to be implemented in the specific message checker.
     *
    ...
    /**
     * Function to retrieve the destination role id.
     * <br/>
    ...
    /**
     * Procedure to set the destination role based on the role id defined in
     * the composite XML file. It would retrieve the contract list and iterate
     * through it to check the matching destination role. The message may still
     * be blocked by the term rules.
     * <br/>
     * This function is implemented in the MessageTypeChecker class.
     *
    ...
    /**
     * Function to retrieve the destination contract.
     * <br/>
     * This function is implemented in the MessageTypeChecker class.
     *
     ...
     * between two roles, it may still be blocked by the term rules.
     * <br/>
     * This function is implemented in the MessageTypeChecker class.
     *
