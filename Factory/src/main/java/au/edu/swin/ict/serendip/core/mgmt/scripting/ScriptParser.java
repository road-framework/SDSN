...
public class ScriptParser {
    ...
    public static Script parseScript(String scriptText) throws RecognitionException, TokenStreamException {
        //Reader reader = new BufferedReader(new FileReader("E://ROAD/workspace/myantlr/src/kau/serscript/test.script"));
    ...
    public static Script parseBlock(String blockText) throws RecognitionException, TokenStreamException {
